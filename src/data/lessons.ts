...
`,
  ...
  // --- Compiled from lessons-in-development (2026-02-15) ---
  {
    id: 'data-viz-07',
    ...
    keywords: ['physicalization', 'encoding', 'textile', 'mapping', 'data-art'],
    content: `# Stitching Data: Physicalization and Knitting
...
:::`,
    challenges: [
      {
        id: 'data-viz-07-c1',
        title: 'Mapping Colors to Mood',
        language: 'python',
        difficulty: 'beginner',
        starterCode: `# We have a list of sentiment scores from -1 (sad) to 1 (happy)
...
`,
        ...
        hints: [
          'Use an `if` statement to check if the `score` is less than 0.',
          'Use `else` to catch all scores 0 or higher.',
          'Make sure to print the exact strings "Use Indigo yarn" or "Use Amber yarn".',
        ],
        solution: `daily_scores = [-0.5, 0.2, 0.8, -0.1]
...
`,
      ...
      {
        id: 'data-viz-07-c2',
        title: 'Determining Pattern Length',
        language: 'python',
        difficulty: 'beginner',
        starterCode: `# In knitting, "Scale" can represent frequency.
...
`,
        expectedOutput: 'Knit 2 rows\nKnit 5 rows\nKnit 1 rows',
        hints: [
          'You need to combine the string "Knit " with the variable `count` and the string " rows".',
          'Remember that you can\'t add a number to a string directly; use `str(count)` or an f-string like `f"Knit {count} rows"`.',
        ],
        solution: `mentions_per_page = [2, 5, 1]
...
`,
  ...
  },
  {
    ...
    keywords: ['svg', 'vector', 'laser-cutting', 'fabrication', 'metadata'],
    content: `# Cutting Through Data: Laser Cutting and Plotting
...
:::`,
    challenges: [
      {
        id: 'data-viz-08-c1',
        title: 'Mapping Citations to Circles',
        language: 'python',
        difficulty: 'beginner',
        starterCode: `# We have a list of how many times a specific author was cited in 3 chapters.
...
`,
        expectedOutput: 'Circle at x=50, radius=20\nCircle at x=150, radius=50\nCircle at x=250, radius=30',
        hints: [
          'Use an f-string to combine the variables: `f"Circle at x={x_position}, radius={radius}"`.',
          'Ensure you are using the `radius` variable calculated inside the loop.',
        ],
        solution: `citations = [2, 5, 3]
x_position = 50
...
`,
      ...
      {
        id: 'data-viz-08-c2',
        title: 'The "Cut" vs. "Engrave" Logic',
        language: 'python',
        difficulty: 'intermediate',
        starterCode: `# Laser cutters use color to distinguish between 
...
`,
        expectedOutput: 'Year: 1920, Color: BLUE\nYear: 1921, Color: RED',
        hints: [
          'Use an `if item["status"] == "Critical":` statement.',
          'Define a `color` variable based on that condition.',
        ],
        solution: `metadata = [
    {"year": 1920, "status": "Standard"},
    {"year": 1921, "status": "Critical"},
...
`,
  ...
  },
  {
    ...
    keywords: ['3D-printing', 'STL', 'topography', 'haptics', 'extrusion'],
    content: `# Topographies of Information: 3D Data Sculptures
...
:::`,
    challenges: [
      {
        id: 'data-viz-09-c1',
        title: 'Defining the Z-Peak',
        language: 'python',
        difficulty: 'beginner',
        starterCode: `# We are building a 'Ridge' representing 100 years of archive growth.
...
`,
        expectedOutput: '[[1900, 5], [1950, 15], [2000, 50]]',
        hints: [
          'Use `.append([x, z])` inside the loop.',
          'The `x` represents the horizontal position, and `z` represents the height of the 3D print.',
        ],
        solution: `years = [1900, 1950, 2000]
growth = [5, 15, 50]
...
`,
      ...
      {
        id: 'data-viz-09-c2',
        title: '3D Coordinate Mapping',
        language: 'python',
        difficulty: 'intermediate',
        starterCode: `# To make a 3D point, we need [X, Y, Z].
...
`,
        expectedOutput: '[1850, 10, 42]',
        hints: [
          'Mapping order: X = year, Y = width, Z = mentions.',
          'Put them in brackets: `[var1, var2, var3]`.',
        ],
        solution: `year = 1850
mentions = 42
width = 10
