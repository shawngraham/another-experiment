...
1. Use corpora.Dictionary(documents) to create the map.
2. The method is dictionary.doc2bow(documents[0]).
3. In Gensim, dictionary[0] will look up the string associated with the first ID created.
4. The expected output assumes "crown" was the first word processed by the dictionary.
