    ...
    <div className="max-w-4xl mx-auto p-8 prose prose-indigo">  
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-800 mb-4">Why?</h2>
         <p className="text-gray-600 mb-8">
        This site is meant as both an introduction and a reminder of basic digital humanities literacies. In my teaching, I have found that there still needs to be some sort of support for students, <em>before</em> they begin to explore the excellent <a href="https://programminghistorian.org/">Programming Historian</a> tutorials, or Melanie Walsh's wonderful <a href="https://melaniewalsh.github.io/Intro-Cultural-Analytics/welcome.html#">Introduction to Cultural Analytics</a>. This site allows the student to get a handle on the fundamentals, and the language of coding and DH <em>without</em> having to install and configure their own machine. Once a student has worked through these materials, they should then be ready for the in-depth tutorials from The Programming Historian or Introduction to Cultural Analytics.
        </p>
      </section>
